...
def F(w):
    ...
    '''
    m,muhat,e,c,l,rho1_,rho2,phi,x_,kappa_ = w[:10] #y
    EUc,EUc_mu,Ex_,Erho1_ = w[10:14] #e
    alpha1,alpha2,tau,eta,lamb = w[14:19] #Y
    m_,muhat_,e_ = w[19:22] #z
    x,kappa = w[22:24] #v
    eps = w[24] #shock
...
def f(y):
    ...
    '''
    m,muhat,e,c,l,rho1_,rho2,phi,x_,kappa_ = y
...
def Finv(YSS,z):
    ...
    return np.vstack((
    m,muhat,e,c,l,rho1,rho2,phi,x,kappa   
    ))
...
def GSS(YSS,y_i):
    ...
    '''
    m,muhat,e,c,l,rho1,rho2,phi,x,kappa = y_i
    alpha1,alpha2,tau,eta,lamb = YSS
